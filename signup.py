...
def connect_database():
    if emailEntry.get() == '' or usernameEntry.get() == '' or passwordEntry.get() == '' or confirmEntry.get() == '' or '@' not in emailEntry.get() or not emailEntry.get().endswith('.com'):
        messagebox.showerror("Error", "Please fill in all fields and provide a valid email.")
